...
public class SlackApp {
        ...
        @Bean
        public App initSlackApp(AppConfig config, InstallationService fileInstallationService) {
                App app = new App(config).asOAuthApp(true);
                app.service(fileInstallationService);
        ...
        @Bean
        public InstallationService fileInstallationService(AppConfig config) {
            FileInstallationService store = new FileInstallationService(config, "/data/slack/installations");    
            store.setHistoricalDataEnabled(true);
            return store;
        }
